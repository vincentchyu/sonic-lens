module github.com/vincentchyu/sonic-lens
...
require (
	...
	github.com/aws/smithy-go/metrics/smithyotelmetrics v1.0.12 // indirect
	github.com/aws/smithy-go/tracing/smithyoteltracing v1.0.12 // indirect
